...
int main() {
	...
	int a, b, c; // DECLARAMOS VARIABLES
	
	printf ("Ingrese un numero: "); // PEDIMOS QUE INGRESE UN NUMERO
	scanf ("%d", &a); // ALMACENAMOS EL 1° NUMERO EN UNA VARIABLE
	
	printf ("Ingrese el segundo numero: "); // PEDIMOS QUE INGRESE OTRO NUMERO
	scanf ("%d", &b); // ALMACENAMOS EL 2° NUMERO EN UNA VARIABLE
	
	printf ("Ingrese el tercer numero: "); // PEDIMOS QUE INGRESE OTRO NUMERO
	scanf ("%d", &c); // ALMACENAMOS EL 3° NUMERO EN UNA VARIABLE
	
	if (a>b){
		if (b>c){
			printf("El orden de los numeros de Mayor a Menor es: %d, %d, %d", a, b, c);
		}
		else{
			if (a>c){
				printf ("El orden de los numeros de Mayor a Menor es: %d, %d, %d", a, c, b);
			}
			else{
				printf ("El orden de los numeros de Mayor a Menor es: %d, %d, %d", c, a, b);
			}
		}
	}
	else{
		if (c > b){
			printf ("El orden de los numeros de Mayor a Menor es: %d, %d, %d", c, b, a);
		}
		else{
			if (a>c){
			printf ("El orden de los numeros de Mayor a Menor es: %d, %d, %d", b, a, c);
			}
			else{
			printf ("El orden de los numeros de Mayor a Menor es: %d, %d, %d", b, c, a);
			}
		}
	}	
