...
int main() {
	int numero1, numero2, resultado; // DECLARAMOS VARIABLES
	...
	resultado = numero1 - numero2; // ASIGNAMOS VALOR A LA 3° VARIABLE
	printf("El resultado de la diferencia entre ambos numeros es %d\n", resultado);
	if (resultado < 0 ) // INDICAMOS CONDICIONAL, CONDICIONAMOS LA VARIABLE
	{
		printf ("El resultado es un numero negativo. \n"); // MOSTRAMOS EN BASE A LA CONDICION
	}
	else{
