...
int main ()
{
int a = 7;     // Declara Variables y asinga Valor Constante
float b = 8.2; // Declara Variables y asinga Valor Constante
char c = 's';  // Declara Variables y asinga Valor Constante

printf ("%d \n \t %f \n \t \t \t %c", a,b,c);
// %d Dato Entero Decimal
// \n Enter
// \t Tabulador
// %f Dato Real escrito con punto decimal como signo
// \n Enter
// \t Tabulador
// \t Tabulador
// %c Dato Caracter
